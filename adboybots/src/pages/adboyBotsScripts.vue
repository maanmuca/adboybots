                                ...
                                <v-layout row wrap class="pl-2 pr-2 pb-2 pt-0 mt-0 text-xs-center">
                                        ...
                                        <v-flex   xs12 class="pl-3 pb-3" v-for="(templateSection,indexTemplateSection) in myTemplates[indexTemplate].templateSections" :key="'section-features-'+indexTemplateSection"  >
                                             ...
                                             <v-hover :key="'v-hover-index-Sections'+indexTemplateSection">
                                                <v-card light color="white" slot-scope="{ hover }" :class="`elevation-${hover ? 3 : 6}`" v-on:click="changePosSection(indexTemplate,indexTemplateSection)" >
                                                    ...
                                                    <v-layout row wrap class="pl-2  pr-2">
                                                        <v-flex  xs6 :style="templateSection.sectionName ==sectionSelected? 'border-color:#007bff; font-size:20px;':''" :class="templateSection.isModifiable? 'text-xs-left pt-2 pl-2':'text-xs-left pt-3 pl-2'">
                                                            ...
                                                            <span><i  :style="templateSection.sectionName ==sectionSelected ? 'font-style: normal; color:#007bff; font-size:16px;': 'font-style: normal; color:black; font-size:16px; margin-top:10px;'">{{templateSection.sectionName }}</i></span>
                                                        </v-flex>
                      ...
                      <v-card light color="white" style= "height:450px; overflow-y: scroll; overflow-x: scroll; " class="pa-3"  >
                        <template v-for="(templateSection,indexTemplateSection) in myTemplate.templateSections">  
                            <template v-if="sectionSelected == templateSection.sectionName" >    
                                ...
                                <v-container :key="'mySection-'+indexTemplateSection" style="width:14000px;">
                                    <template v-for="(sectionMessage,indexSectionMessage) in templateSection.sectionMessages" >
                                        ...
                                        <v-layout class="pb-5"   v-if="sectionMessage.type=='simple_text'" :key="'simpleMessage-'+indexSectionMessage"  style="width:2500px;">
                                        ...
                                        <v-layout v-if="sectionMessage.type=='quick_reply'" :key="'quick-replies-'+indexSectionMessage" class="pb-5" style="width:2500px;">
                                        ...
                                        <v-layout v-if="sectionMessage.type=='button_template'" :key="'layout-button'+indexSectionMessage+indexButton" :class="ispb5(indexTemplate,indexTemplateSection,indexSectionMessage,indexButton)? 'pb-5':'pb-0'" style="width:2500px;">
                                            ...
                                            <v-hover  :key="'v-hover-button'+indexSectionMessage+indexButton">
                                                <span slot-scope="{ hover }" :class="`pl-2 pr-2 elevation-${hover ? 2 : 8}`" v-on:click="dialogEditbuttonTemplate(indexTemplate,indexTemplateSection,indexSectionMessage,indexButton)" style="background-color:transparent; width:300px; border:solid 1px #007bff; margin: 4px 0 2px 0; border-radius:5px;" >
                                        ...
                                        <!--------------------------------------Gallery------------------------------------------>
                                        <v-layout v-if="sectionMessage.type=='Gallery Template'" style="width:456px;" :key="'list-categories-'+indexSectionMessage" >
                                        ...
                                        <v-layout v-if="sectionMessage.type=='Gallery Template'" :key="'gallery-'+indexSectionMessage">
                                            ...
                                            <v-container class="pb-0 pl-0" >
                                                ...
                                                <v-layout class="pb-0">
                                                    ...
                                                    <p style="color:white;" class="title">Image gallery 1</p>
                                                    </span>
                                                </v-layout>
                                                <v-layout class="pb-0" >
                                                    <span class="pl-2 pr-2 pt-3"><v-icon small color="transparent">fas fa-arrow-up</v-icon></span>
 ...
 data: () => (
  {
    ...
    typeOfMessages:[
        ...
        {description:"Gallery Template",type:'gallery_template'},
    ],
    templateSelected:"",
      ...
      addMessage(typeOfMessage,indexTemplate,indexTemplateSection)
      {
          ...
          switch(typeOfMessage) {
            ...
            case 'gallery_template':
                console.log("I am gallery_template");
            break;
            }
      },
